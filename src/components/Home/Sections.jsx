/* 만약 SectionBlock을 선언 하였다면, 선언한 그 변수에 해당하는 뭔가가 정의 되어야 함. 아니면 화면에 아무것도 뜨지 않음. */
import "./sections.css";
...
const Sections = () => {
    return (
        <div className="div1">
                        ...
                        <div className="row_right_tight">
                            ...
                            <div className="nearest_store">
                                ...
                                >
                                    ...
                                    ></path>
                                    <path
                                        d="m12.4934 4.675a10.5617 10.5617 0 0 1 4.177.8275 10.8868 10.8868 0 0 1 5.7467 
                                    ...
                                    1 .011.1984 2.3284 2.3284 0 0 1 -.528 1.4222 1.9664 1.9664 0 0 1 -1.375.7276z"
                                    ></path>
                                </svg>
                                <div className="nearest-store-container">
                                    ...
                                    <div className="shop-chat-content">
                                        <a href="https://www.apple.com/kr/retail/">
                                            가까운 매장 찾기
                                            <img
                                                src="./assets/img/next-blue.svg"
                                                alt=""
                                                height={8}
                                            />
                                        </a>
            ...
            <section className="shelf2">
                <div className="shelf2_div">
                    {/* 외부 URL을 이용하기에 Link태그를 사용하지 않음 */}
                    <a href="https://www.apple.com/kr/shop/buy-mac">
                        <img src="./assets/img/image_1.jpg" alt="" />
                        <p>Mac</p>
                    </a>
                </div>
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_2.jpg" alt="" />
                        <p>iPhone</p>
                    </a>
                </div>
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_3.jpg" alt="" />
                        <p>iPad</p>
                    </a>
                </div>
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_4.jpg" alt="" />
                        <p>Apple Watch</p>
                    </a>
                </div>
                <div className="shelf2_div">
                ...
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_6.jpg" alt="" />
                        <p>AirTag</p>
                    </a>
                </div>
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_7.jpg" alt="" />
                        <p>Apple TV 4K</p>
                    </a>
                </div>
                <div className="shelf2_div">
                    <a href="https://www.apple.com/kr/shop/buy-iphone">
                        <img src="./assets/img/image_8.jpg" alt="" />
                        <p>액세서리</p>
                    </a>
                </div>
            </section>
